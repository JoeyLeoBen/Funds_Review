...
-- Returns less fees
SELECT rf.fund_company, r.fund_identifier, CONCAT(r.fund_identifier,' - ',rfunds.funds) AS funds, r.date, r.returns, rf.fees, (((r.returns / 100) + 1) - (0.0833333333333333 * rf.fees)) AS returns_less_fees
