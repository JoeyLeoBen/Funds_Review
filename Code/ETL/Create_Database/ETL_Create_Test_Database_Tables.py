...
###########################################################################################################################################
# NEW CODE BLOCK - Create test_db
###########################################################################################################################################


def create_database():
    """
    - Creates and connects to the test_db
    - Returns the connection and cursor to test_db
    """
    ...
    # create test_db database with UTF8 encoding
    cur.execute("DROP DATABASE IF EXISTS test_db;")
    cur.execute("CREATE DATABASE test_db WITH ENCODING 'utf8' TEMPLATE template0;")
...
#########################################################################################################################################
# NEW CODE BLOCK - Create tables in test_db
###########################################################################################################################################
...
def main() -> None:
    """
    - Drops (if exists) and creates the test_db database
    - Establishes connection with the test_db database and gets cursor to it
